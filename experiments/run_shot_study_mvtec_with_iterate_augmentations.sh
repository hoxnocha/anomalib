...
python ./scripts/few_shot_training_iterate_augmentations.py --backbone antialiased_wide_resnet50_2  --dataset airogs --augment True --number-transforms 8 --k-shots 1 5 10 --batch-size 4 2 1
